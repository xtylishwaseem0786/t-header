...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Waseem.flf ]; then
	echo -e "\e[1;34m[*] \033[32mWaseem.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/remo7777/REMO773/master/Remo773.flf &> /dev/null;
sleep 3
cp Waseem.flf $PREFIX/share/figlet/Waseem.flf;
...
bash ~/Waseem/.banner.sh ${col} ${TNAME}
echo "";
...
clear;
echo -e "\033[31m$(figlet -f Remo773 "Waseem")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Waseem : (\e[33m14.4.2021\e[32m)

* Auther : Xtylish Waseem
* Github : https://github.com/Xtylishwaseem786/
* Youtube : https://youtube.com/channel/UCUl9WvNA3XZtiIviaAWwJ8Q 
* What'sapp : 03153171257
+----------------------------------*/
\033[0m";
tput setaf 3;
